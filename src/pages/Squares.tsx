...
const Squares: React.FC<SquaresProps> = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      const border = isDark ? "#2563eb" : "#60a5fa";
      const hoverFill = isDark ? "#2563eb33" : "#93c5fd66";
      ...
      for (let x = startX; x < canvas.width + squareSize; x += squareSize) {
        for (let y = startY; y < canvas.height + squareSize; y += squareSize) {
          ...
          // Compare against global hovered square coordinates
          if (
      ...
      gradient.addColorStop(1, isDark ? "#2563eb22" : "#93c5fd22");
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      // Calculate hovered square in global grid coordinates
